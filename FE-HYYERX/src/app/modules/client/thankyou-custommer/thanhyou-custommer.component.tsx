...
const ThankCustomers: FunctionComponent<ThankCustomersProps> = () => {
  return (
    <div className="flex items-center justify-center h-min">
      <div className=" w-[1140px] m-3 p-2 shadow-xl bg-gradient-to-r">
        <div className="flex flex-col items-center  bg-white">
          ...
          <h1 className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-red-500 ">KiKi Thank You !</h1>
          <div className='text-xl text-center max-sm:w-full w-2/4'>
          ...
          <div className='flex justify-between'>
            <div className="inline-flex items-center text-white bg-red-700 border rounded-3xl hover:text-red-700 hover:bg-white focus:outline-none focus:ring mx-4">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-14 h-14 mr-2" fill="none" viewBox="0 0 24 24"
                stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M7 16l-4-4m0 0l4-4m-4 4h18" />
              </svg>
              <button className="text-xl font-medium px-6">
                < Link to={'/products'}>Tiếp tục mua hàng</Link>
              </button>
            </div>

            <div className="inline-flex items-center  text-white bg-red-700 border  rounded-3xl hover:text-red-700 hover:bg-white focus:outline-none focus:ring">
              <button className="text-xl font-medium px-6">
                < Link to={'/manage-order'}>Xem đơn hàng</Link>
              </button>
