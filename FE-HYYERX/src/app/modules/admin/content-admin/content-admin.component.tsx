...
const ContentAdmin = () => {
    ...
    return (
        <div>
            <TemplateTable
                dataTable={dataContent} setNewData={setDataContent} searchFunc={searchContent} columsTable={column} deleteFunc={deleteContent} changeFunc={updateContent} handelGetlist={handelGetList} createFunc={createContent}
                formEdit={
                    <Fragment>
                        <Form.Item
                            label='Nội dung'
